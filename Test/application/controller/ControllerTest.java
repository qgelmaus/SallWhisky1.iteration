...
class ControllerTest {
    ...
    void opretFad() {
        ...
        //Act
        controller.opretFad("Sherry", 300, false, "1", LocalDate.of(2023, 11, 20), "Skotland");

        //Assert
        assertEquals(fad1, controller.opretFad("Sherry", 300, false, "1", LocalDate.of(2023, 11, 20), "Skotland"));
